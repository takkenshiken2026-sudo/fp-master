...
GENRE_OUTLINES: dict[str, dict[str, object]] = {
    ...
    "属性別・状況別": {
        "title": "◯◯試験の【属性・状況】別ガイド",
        "meta": "◯◯試験を属性・状況別に受験するメリットと学習の進め方を整理します。",
        "lead": "自分の立場に合わせて、学習時間の確保と優先順位を決めたい人向けの記事です。",
        "tags": "属性別;状況別;FP3級",
        "sections": ["対象者の特徴と受験の背景", "受験するメリット", "学習時間の確保と進め方", "つまずきやすいポイント", "次に読む記事"],
        "faqs": [
            ("自分の状況でも受験できますか？", "受験資格は公式の受験案内で確認してください。"),
            ("いつから勉強を始めればよいですか？", "試験日程と学習時間の目安を見て、余裕を持った開始を推奨します。"),
        ],
        "related": "study-plan:学習計画;self-study-roadmap:独学ロードマップ",
        "priority": 10,
    },
    "分野別対策（6科目別）": {
        "title": "◯◯試験の【分野名】の出題傾向と対策",
        "meta": "◯◯試験の分野別出題傾向、頻出論点、計算問題の対策を整理します。",
        "lead": "特定分野の得点を伸ばしたい人向けに、出題傾向と演習の進め方をまとめます。",
        "tags": "分野別;6科目;FP3級",
        "sections": ["出題傾向の概要", "頻出論点と押さえるポイント", "計算・暗記のコツ", "このサイトでの演習の使い方", "直前期の確認事項"],
        "faqs": [
            ("苦手分野だけ先に学べますか？", "全体像把握後に集中すると効率が上がります。"),
            ("6科目すべて完璧にする必要はありますか？", "配点と得意不得意を見て優先順位を決めてください。"),
        ],
        "related": "past-question-strategy:過去問の使い方;glossary-how-to:用語整理",
        "priority": 20,
    },
    "学科・実技の違いと対策": {
        "title": "◯◯試験の学科・実技の違いと対策",
        "meta": "◯◯試験の学科試験と実技試験の違い、選び方、対策の分け方を整理します。",
        "lead": "学科と実技の違いを理解し、自分に合った受験スタイルを選びたい人向けの記事です。",
        "tags": "学科;実技;FP3級",
        "sections": ["学科試験と実技試験の違い", "選び方と受験の組み合わせ", "実技試験の対策の進め方", "落ちやすいパターン", "次に確認すること"],
        "faqs": [
            ("学科と実技は別々に受験できますか？", "試験実施団体の案内で確認してください。"),
            ("実技だけ先に受けることはできますか？", "受験順序・免除の有無は公式要項を確認してください。"),
        ],
        "related": "exam-overview:試験概要;study-plan:学習計画",
        "priority": 30,
    },
    "比較・選択系": {
        "title": "◯◯試験の【比較テーマ】ガイド",
        "meta": "◯◯試験に関する選択肢の比較と、受験者へのおすすめを整理します。",
        "lead": "複数の選択肢で迷っている人向けに、比較のポイントと判断基準をまとめます。",
        "tags": "比較;選択;FP3級",
        "sections": ["比較のポイント", "それぞれの特徴", "受験者へのおすすめ", "学習への影響", "判断のまとめ"],
        "faqs": [
            ("どちらを選べばよいですか？", "目的・予算・学習スタイルで判断してください。"),
            ("後から変更できますか？", "制度・契約条件は公式情報で確認してください。"),
        ],
        "related": "self-study-roadmap:独学ロードマップ;study-plan:学習計画",
        "priority": 40,
    },
    "合格後・活用": {
        "title": "◯◯試験合格後の【活用テーマ】",
        "meta": "◯◯試験合格後の資格活用、キャリア、継続学習について整理します。",
        "lead": "合格後に資格をどう活かすか、次のステップを知りたい人向けの記事です。",
        "tags": "合格後;活用;FP3級",
        "sections": ["合格後にできること", "資格の活用シーン", "履歴書・職場での記載", "継続学習と上位資格", "よくある誤解"],
        "faqs": [
            ("合格証はいつ届きますか？", "試験実施団体の案内で確認してください。"),
            ("資格は更新が必要ですか？", "継続教育・登録制度は公式情報で確認してください。"),
        ],
        "related": "exam-overview:試験概要;study-plan:学習計画",
        "priority": 50,
    },
    "よくある質問": {
        "title": "◯◯試験の【FAQテーマ】",
        "meta": "◯◯試験についてよくある質問と、公式情報に基づく答えを整理します。",
        "lead": "受験前によく検索される疑問に、公式情報の確認方法と合わせて答えます。",
        "tags": "FAQ;よくある質問;FP3級",
        "sections": ["質問の背景", "公式情報で確認すること", "受験者が知っておきたい答え", "学習・受験への影響", "関連する確認事項"],
        "faqs": [
            ("最新情報はどこで確認しますか？", "試験実施団体の公式サイトを優先してください。"),
            ("体験談だけで判断してよいですか？", "参考程度にし、制度・数値は公式情報で確認してください。"),
        ],
        "related": "exam-overview:試験概要;study-plan:学習計画",
        "priority": 60,
    },
    "学習ツール・サイト活用": {
        "title": "◯◯試験の【学習ツール】活用法",
        "meta": "◯◯試験の学習ツール・サイトの選び方と効果的な使い方を整理します。",
        "lead": "アプリ・過去問サイト・一問一答など、学習ツールを組み合わせたい人向けの記事です。",
        "tags": "学習ツール;サイト活用;FP3級",
        "sections": ["ツール・サイトの選び方", "効果的な使い方", "学習フェーズ別の活用法", "このサイトとの組み合わせ", "続けるためのコツ"],
        "faqs": [
            ("無料だけで足りますか？", "弱点と公式範囲の確認ができていれば可能な場合もあります。"),
            ("複数のツールを併用してもよいですか？", "役割を分けて使うと効率的です。"),
        ],
        "related": "past-question-strategy:過去問の使い方;glossary-how-to:用語整理",
        "priority": 70,
    },
    "制度・法改正対応": {
        "title": "◯◯試験の【制度・法改正】と出題への影響",
        "meta": "◯◯試験における制度・法改正のポイントと、学習で押さえるべき内容を整理します。",
        "lead": "法改正や制度変更が出題にどう影響するかを知りたい人向けの記事です。",
        "tags": "法改正;制度変更;FP3級",
        "sections": ["制度変更の概要", "出題への影響", "学習で押さえるポイント", "公式情報の確認先", "直前までの見直し方"],
        "faqs": [
            ("去年のテキストは使えますか？", "改定範囲を公式情報で確認してください。"),
            ("いつ時点の制度が試験範囲ですか？", "試験要項・シラバスの基準日を確認してください。"),
        ],
        "related": "exam-overview:試験概要;study-plan:学習計画",
        "priority": 80,
    },
