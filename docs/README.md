...
3. **[site-registry.md](./site-registry.md)** … **本番10サイト一覧**（URL・Git・同期難易度）
4. **[DEPLOY.md](./DEPLOY.md)** … **GitHub Actions デプロイ標準**
5. **[integration-checklist.md](./integration-checklist.md)** … **過去問ハブ・3モードタブ・フッター・用語一覧を一回で揃える**（本番同期・再発防止）
6. **[seo-article-guidelines.md](./seo-article-guidelines.md)** … 記事・用語・色・内部リンク・公開前チェック（**正本**）
   ...
   - **有料模試（note）導線:** **[paid-mock-exam.md](./paid-mock-exam.md)**（05番カード・結果 CTA・配色）
...
4e. [.cursor/rules/paid-mock-exam.mdc](../.cursor/rules/paid-mock-exam.mdc) … 有料模試（note）05番・結果 CTA・赤バナー
